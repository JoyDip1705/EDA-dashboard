# 📊 Restaurant Operations & Sales Analytics Dashboard
...
• Top Level: Filter controls (Online Delivery, Table Booking) and 4 Critical KPI Metric Cards.
• Middle Grid: Market Cuisines (Bar), Text Ratings (Donut), and Cost-to-Rating ratios (Bar).
• Bottom Grid: Structural Rating Colors (Bar), Operational Booking Splits (Donut), and Engagement Scaling (Line).
